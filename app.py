...
async def post_movie(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Send first photo as main poster (with caption + buttons)
    try:
    ...
    for i in range(1, len(photos)):
        try:
            ...
            logger.warning(f"Failed to send extra photo: {e}")
